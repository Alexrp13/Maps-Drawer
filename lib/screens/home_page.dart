        ...
        child: ListView(
          ...
          children: <Widget>[
            UserAccountsDrawerHeader(
                accountName: Text('Toni', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24)) ,
                accountEmail: Text('Tonieetac@gmail.com', style: TextStyle(fontSize: 18)),
                currentAccountPicture: CircleAvatar(backgroundImage: AssetImage("assets/icons/logo.jpeg")),
            ),
            ListTile(
